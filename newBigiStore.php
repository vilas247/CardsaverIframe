...
<html lang="en">
  <head>
    ...
    <link href="css/247csiframeloader.css" rel="stylesheet">
	<style>
		.hbspt-form{
			display:none;
		}
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 box lanch-store">         
            ...
            <div class="row py-2">
              <div class="col-md-6 my-2">
                ...
                <input type="text" class="form-control" name="storeName" id="storeName" placeholder="cardsaver" required>
              </div>
              <div class="col-md-6 my-2">
            ...
            <div class="row py-2">
              ...
              <div class="col-md-4 my-2">
                ...
                <input type="text" class="form-control" id="confi-id" placeholder="Cardsaver" required>
              </div>
              <div class="col-md-4 my-2">
                <label>Store Plan</label>
				<select class="form-control custom-input" name="Storeplan" id="Storeplan" required>
          ...
          <div class="col-md-12 lanch-store mt-3">
            <p class="text-end"><button type="submit" class="btn btn-primary btn-lg btn-store"><img src="images/icon-lanch.jpg" width="28" class="me-2"/>Launch Store</button></p>
          </div>
		  </form>
        </div>
      </div>
    ...
    <script src="js/247csiframeloader.js"></script>
  </body>
  </html>
  <script>
	toastr.options = {
