...
<head>
    ...
    <title>CardStream Payments</title>
...
<section class="inner-top">
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center logo"> <img src="images/card-saver.png" alt="logo" class="img-responsive"></div>
		</div>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="row rows">
			<div class="order-details-bg settle">
				<form action="updateCustomButton.php" method="POST" id="updateCustomButton" >
