...
<html lang="en">
   <head>
      ...
      <title>CardSaver | Dashboard</title>
      <!-- Bootstrap -->
    ...
    <section class="order-section">
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				<div class="modal-header">
				  <h5 class="modal-title" id="exampleModalLongTitle"><span><img src="images/icons/trash-purple.svg" style="margin-top: -5px;"></span> <span class="purple">Disable CardSaver</span>  </h5>
				  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				  </button>
				</div>
				<div class="modal-body" id="modalContent">
				  Are you sure you want to disable <strong>CardSaver in BigCommerce?</strong>.
				</div>
      ...
      <script>
		...
		$(document).ready(function(){
			...
			if(enabled){
				alert("Cardsaver Payments enabled for your Store");
			}
			var disabled = getUrlParameter('disabled');
			if(disabled){
				alert("CardSaver Payments disabled for your Store");
			}
		});
